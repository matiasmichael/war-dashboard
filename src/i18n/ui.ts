...
export const ui = {
  en: {
    ...
    // ===== Archive page =====
    'archive.title': 'Daily Summary — Middle East Pulse',
    'archive.description': 'Historical daily intelligence summaries from the Middle East conflict',
    'archive.heading': '📅 Daily Summary',
    'archive.loading': 'Loading summary...',
    'archive.jsRequired': 'JavaScript Required',
    'archive.jsRequiredDesc': 'This page requires JavaScript to load daily summaries. Please enable JavaScript in your browser settings.',
    'archive.noYet': 'No summaries yet',
    ...
    'archive.notAvailable': 'Summary not available',
    ...
    'archive.generatedAt': 'Summary generated at',
    'archive.dailyBriefing': 'Daily Intelligence Summary',
    ...
    'about.dailyBriefingSchedule': 'Daily Summary',
    ...
    'about.archiveSection': 'Daily Summary Archive',
    'about.archiveSectionDesc': 'Each night, a comprehensive daily intelligence summary is generated and preserved in the archive. It includes an escalation assessment, a timeline of key events, a full narrative summary, and "what changed today" notes.',
  ...
  he: {
    ...
    // ===== Archive page =====
    'archive.title': 'סיכום יומי — מד הדופק',
    'archive.description': 'תדריכי מודיעין יומיים היסטוריים מעימות המזרח התיכון',
    'archive.heading': '📅 סיכום יומי',
    'archive.loading': 'טוען תדריך...',
    'archive.jsRequired': 'נדרש JavaScript',
    'archive.jsRequiredDesc': 'עמוד זה דורש JavaScript כדי לטעון סיכומים יומיים. אנא הפעל JavaScript בהגדרות הדפדפן שלך.',
    'archive.noYet': 'אין סיכומים עדיין',
    'archive.noYetDesc': 'סיכומי מודיעין יומיים יופיעו כאן לאחר שיופק הסיכום היומי הראשון. בדוק שוב מחר.',
    'archive.notAvailable': 'הסיכום אינו זמין',
    ...
    'archive.generatedAt': 'הסיכום הופק ב-',
    'archive.dailyBriefing': 'סיכום מודיעין יומי',
    ...
    'about.dailyBriefingSchedule': 'סיכום יומי',
    ...
    'about.archiveSectionDesc': 'כל לילה, סיכום מודיעין יומי מקיף מופק ונשמר בארכיון. הוא כולל הערכת הסלמה, ציר זמן של אירועים מרכזיים, סיכום נרטיבי מלא והערות "מה השתנה היום".',
